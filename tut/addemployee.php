...
$mobile = $_POST['mobile'];
$emergency = $_POST['emergency_no'];
$emr_contact_name = $_POST['emer_contact_person'];
...
$quary1 = "INSERT INTO personal_data (ID,first_name,last_name,birthday,NIC_no,gender,house_no,lane,city,district,province,mobile_number,fixed_number) VALUES ('$reg_num','$first_name','$last_name','$birth_day','$NIC','$gender','$house_no','$lane','$city','$district','$province', '$mobile','$land_line')";
...
$quary3 = "INSERT INTO emergency_reco (ID,name,number) VALUES ('$reg_num','$emr_contact_name','$emergency')";
...
$qry = "SELECT* FROM leave_type where salary_id = '$salary_id'";
...
while($row=mysqli_fetch_assoc($results)){
    ...
    $qry1 = "INSERT INTO leave_count VALUES('$reg_num',$anual,$casual,$nopay,$maternity)";

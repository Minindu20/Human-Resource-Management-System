          ...
          <div class="card shadow-sm">
            <div class="card-header bg-transparent text-center">
              ...
              session_start();
                ...
                $qery =  "SELECT personal_data.ID,personal_data.first_name,personal_data.last_name,personal_data.gender,personal_data.house_no,personal_data.lane,personal_data.city,personal_data.birthday,personal_data.NIC_no,phone_numbers.number,employee.dept_name,employee.sup_ID,salary.amount,title.job,branch.city as branch_city,status.state
                          FROM personal_data
                          INNER JOIN employee ON employee.ID=personal_data.ID
                          inner join salary on salary.salary_ID=employee.salary_ID
                          ...
                          inner join phone_numbers on phone_numbers.ID=employee.ID
                          where employee.ID= $reg_num"; 

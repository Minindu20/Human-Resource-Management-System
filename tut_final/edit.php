<?php
    ...
    $sql1 = "UPDATE leave_table set status='Aproved' where ID= $ID1 and requested_date = '$requested_date'";
    ...
    $qry4 = "UPDATE leave_count set ".$leave_type. " = $leave-$day_number WHERE ID = $ID1 ";
